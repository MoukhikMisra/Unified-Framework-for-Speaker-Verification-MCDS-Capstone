...
#SBATCH --job-name=test_hf_multi_node_pytorch_launcher_gpt2_wikitext
...
export PROGRAM="\
    run_clm.py \
        ...
        --do_train \
        --output_dir /scratch/bcey/hchen10/haoc/llm/experiments/test_hf_multi_node_pytorch_launcher_gpt2_wikitext \
        --max_train_samples 5000 \
        -deepspeed scripts/deepspeed_zero2_config.yaml \
    "
