...
#SBATCH --job-name=test_hf_multi_node_deepspeed_launcher_llama1b_wikitext
...
export PROGRAM="\
    run_clm_no_trainer.py \
        ...
        --output_dir /scratch/bcey/hchen10/haoc/llm/experiments/test_hf_multi_node_deepspeed_launcher_llama1b_wikitext \
        --max_train_steps 100 \
    "
