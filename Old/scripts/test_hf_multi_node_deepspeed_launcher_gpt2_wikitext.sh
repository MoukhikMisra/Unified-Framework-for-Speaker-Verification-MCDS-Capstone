...
#SBATCH --job-name=test_hf_multi_node_deepspeed_launcher_gpt2_wikitext
...
export PROGRAM="\
    run_clm.py \
        ...
        --do_train \
        --output_dir /scratch/bcey/hchen10/haoc/llm/experiments/test_hf_multi_node_deepspeed_launcher_gpt2_wikitext \
