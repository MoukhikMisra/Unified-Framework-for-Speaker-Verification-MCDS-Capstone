#!/bin/bashd
#SBATCH -p GPU-shared
#SBATCH --partition=gpu:v100-32:4
...
export PROGRAM="\
    run_glue.py \
        ...
        --do_train \
        --do_eval \
        --output_dir /ocean/projects/cis220031p/mmisra/transformers/examples/pytorch/language-modeling/scripts/experiments/sst2256GPU4 \
